const fi = {
  ...
  uses: "Työkalut",
  lab: "LAB AMK",
  unihelsinki: "Helsingin yliopisto",
  ...
  menu: "Valikko",
  usesText:
    "Tässä on lista työkaluista ja sovelluksista joita käytän päivittäin. Tämä sivu on saanut inspiraationsa Wes Bosin projektista - ",
  work: "Työ",
  petProjects: "Harrasteprojektit",
